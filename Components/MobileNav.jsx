...
const MobileNav = () => {
  return (
    <nav className='w-full hidden md:hidden padding fixed bottom-0 left-0 backdrop-blur-md shadow z-50 bg-background-dark dark:bg-background-light dark:text-foreground-light text-foreground-dark rounded-tl-xl rounded-tr-xl'>
