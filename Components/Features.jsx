  ...
  return (
    <div className='padding w-full h-full'>
      ...
      >
        ...
        >
          {[{
            icon: <FaUnlockKeyhole className='text-4xl w-full text-secondary-light dark:text-secondary-dark' />,
            ...
            icon: <RiCalendarScheduleLine className='text-4xl w-full text-secondary-light dark:text-secondary-dark' />,
            ...
            icon: <BsDoorOpenFill className='text-4xl w-full text-secondary-light dark:text-secondary-dark' />,
            ...
            <motion.div
              key={i}
              className='text-center flex flex-col gap-2 border py-4 px-4 rounded-md shadow dark:shadow'
              variants={item}
            >
              {feature.icon}
